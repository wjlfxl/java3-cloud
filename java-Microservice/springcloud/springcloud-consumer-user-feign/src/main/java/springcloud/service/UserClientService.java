...
@FeignClient(value = "SPRINGCLOUD-PROVIDER-USER",configuration = ConfigBean.class,fallbackFactory = UserClientServiceFallBackFactory.class)//fallbackFactory指定降级配置类
